...
func (c *Client) NewGetDailyFinancialsByMarketSegmentRequest() GetDailyFinancialsByMarketSegmentRequest {
	return GetDailyFinancialsByMarketSegmentRequest{
		client: c,

		Header: JCHeader{
			BucketType: "GetDailyFinancialsByMarketSegmentRQ",
			APIType:    "APIType",
			APIVersion: "1.0",
		},
...
type GetDailyFinancialsByMarketSegmentRequest struct {
	client *Client
...
func (r GetDailyFinancialsByMarketSegmentRequest) Do() (GetDailyFinancialsByMarketSegmentResponseBody, error) {
	responseBody := GetDailyFinancialsByMarketSegmentResponseBody{}
...
type GetDailyFinancialsByMarketSegmentResponseBody struct {
	XMLName xml.Name `xml:"Content"`
	Header  struct {
	...
	Body DailyFinancialsByMarketSegment `xml:"Body"`
}
